    ...
    for (r = 0; r < radius.length; r++) {
        for (b = 0; b < n_bin_onWheel; b++) {
            ...
            for (rp = 0; rp < n_repetition; rp++) {
                //add in this part for building the target image series by Bill 12/11/2021
                for (rp = 0; rp < n_repetition; rp++) {
                ...
                basic_condition.push({
                    ...
                    target_series:targetSeries // put target image series in the condition by Bill 12/11/2021                   
                })
            }
