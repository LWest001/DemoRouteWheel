        ...
        function show_current_page() {
            ...
            if (trial.show_page_number) {
                pagenum_display = "<span style='margin: 0 1em;' class='" +
                    "jspsych-instructions-pagenum unselectable'>Page " + (current_page + 1) + "/" + trial.pages.length + "</span>";
            }

            if (trial.show_clickable_nav) {

                var nav_html = "<div class='jspsych-instructions-nav unselectable' style='padding: 10px 0px;'>";
                if (trial.allow_backward) {
                    var allowed = (current_page > 0) ? '' : "disabled='disabled'";
                    nav_html += "<button id='jspsych-instructions-back' class='jspsych-btn unselectable' style='margin-right: 5px;' " + allowed + ">&lt; " + trial.button_label_previous + "</button>";
                }
                if (trial.pages.length > 1 && trial.show_page_number) {
                    nav_html += pagenum_display;
                }
                nav_html += "<button id='jspsych-instructions-next' class='jspsych-btn unselectable'" +
                ...
                if (trial.show_page_number && trial.pages.length > 1) {
                    ...
                    html += "<div class='jspsych-instructions-pagenum unselectable'>" + pagenum_display + "</div>"
                }
                display_element.innerHTML = html;
            }
