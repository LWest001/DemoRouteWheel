    ...
    plugin.info = {
        ...
        parameters: {
            ...
            message: {
                ...
                pretty_name: 'Message',
                default: '<p class="unselectable">The experiment will switch to full screen mode when you press the button below</p>',
                array: false,
    ...
    plugin.trial = function(display_element, trial) {
        ...
        if (keyboardNotAllowed) {
            ...
            if (trial.fullscreen_mode) {
                display_element.innerHTML = trial.message + '<button id="jspsych-fullscreen-btn" class="jspsych-btn unselectable">' + trial.button_label + '</button>';
